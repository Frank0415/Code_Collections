...
void test_CoW_copy() {
    ...
    std::cout << "Use count after second copy: " << r1.use_count() << ", " << r2.use_count() << ", " << r3.use_count() << std::endl;
    ...
    std::cout << "Use count after modify: " << r1.use_count() << ", " << r2.use_count() << ", " << r3.use_count() << std::endl;
